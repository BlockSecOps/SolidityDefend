...
class Soliditydefend < Formula
  ...
  homepage "https://github.com/AdvancedBlockchainSecurity/SolidityDefend"
  version "2.0.1"
  license "MIT OR Apache-2.0"

  on_macos do
    on_arm do
      url "https://github.com/AdvancedBlockchainSecurity/SolidityDefend/releases/download/v2.0.1/soliditydefend-v2.0.1-macos-aarch64.tar.gz"
      sha256 "55f85ee2294a485eb7d0bb48d9ab505d702a5055a2e4268c330e5cb435758714"
    end
    on_intel do
      url "https://github.com/AdvancedBlockchainSecurity/SolidityDefend/releases/download/v2.0.1/soliditydefend-v2.0.1-macos-x86_64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/AdvancedBlockchainSecurity/SolidityDefend/releases/download/v2.0.1/soliditydefend-v2.0.1-linux-x86_64.tar.gz"
      sha256 "d36ad8c83e9508a5050d6a755dfddc1ffffb0beacf7a12a8208e93913610fd71"
    end
    on_arm do
      url "https://github.com/AdvancedBlockchainSecurity/SolidityDefend/releases/download/v2.0.1/soliditydefend-v2.0.1-linux-aarch64.tar.gz"
