...
fn has_function_name(ctx: &AnalysisContext, name: &str) -> bool {
    ctx.get_functions().iter().any(|f| {
        f.name.name.to_lowercase().contains(name.to_lowercase().as_str())
    })
}
...
pub fn has_operator_validation(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    (func_lower.contains("approvedoperators") || func_lower.contains("approved_operators") ||
     func_lower.contains("operatorwhitelist") || func_lower.contains("operator_whitelist") ||
     func_lower.contains("isoperator") || func_lower.contains("is_operator")) &&
...
pub fn has_delegation_cap(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    (func_lower.contains("maxdelegation") || func_lower.contains("max_delegation") ||
     func_lower.contains("delegationcap") || func_lower.contains("delegation_cap")) &&
...
pub fn has_allocation_delay(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    (func_lower.contains("delay") || func_lower.contains("timelock") ||
...
pub fn has_time_delay(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    func_lower.contains("timestamp") &&
    (func_lower.contains("delay") || func_lower.contains(">=") || func_lower.contains("require"))
}
...
pub fn validates_evidence(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    (func_lower.contains("require") || func_lower.contains("length") || func_lower.contains("validate"))
}
...
pub fn has_slashing_delay(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    (func_source.contains("SLASHING_DELAY") || func_source.contains("slashingDelay") ||
...
pub fn has_withdrawal_delay(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    (func_source.contains("WITHDRAWAL_DELAY") || func_source.contains("withdrawalDelay") ||
...
pub fn has_liquidity_reserve(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    (func_lower.contains("liquidity") || func_lower.contains("reserve") || func_lower.contains("buffer")) &&
    (func_lower.contains("percentage") || func_lower.contains("%") || func_lower.contains("/100") || func_lower.contains("* 10"))
}
...
pub fn has_security_validation(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    (func_lower.contains("audit") || func_lower.contains("security") ||
...
pub fn has_proportional_distribution(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    func_lower.contains("/") &&
    (func_lower.contains("totalstaked") || func_lower.contains("total_staked") ||
     func_lower.contains("totalsupply") || func_lower.contains("total_supply"))
}
...
pub fn has_early_withdrawal_penalty(function: &ast::Function, ctx: &AnalysisContext) -> bool {
    ...
    (func_lower.contains("timestamp") && func_lower.contains("<") &&
