# v1.10.20 Baseline — FP Reduction v9

**Date**: 2026-02-06
**Total Findings**: 346 across 18 test targets
...
**0 TP regressions across all 9 rounds of FP reduction.**

## Change History

### Full v1.10.20 FP Reduction (v1-v9, Feb 5-6 2026)

| Metric | v1.10.19 (Start) | v8 (Round 8) | v9 (Current) | Total Change |
|--------|-------------------|---------------|--------------|--------------|
| Total Findings | 1,776 | 427 | 346 | -1,430 (80.5%) |
| Clean FPs | 26 | 0 | 0 | -26 (100%) |
| Detectors Improved | -- | 80+ (14 specific) + 331 (structural) + 7 | 9 additional | -- |
