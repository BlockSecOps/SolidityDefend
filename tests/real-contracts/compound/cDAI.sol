...
/**
 * @title Compound cDAI (Real Production Contract)
 * @notice Official Compound cDAI contract from Ethereum Mainnet
 * @dev Address: 0x5d3a536E4D6DbD6114cc1Ead35777bAB948E3643
 * @dev Used for Phase 4 validation testing
 */
...
contract CErc20Delegator is CTokenInterface, CErc20Interface, CDelegatorInterface {
    constructor(
        ...
        delegateTo(implementation_, abi.encodeWithSignature(
            ...
            underlying_, comptroller_, interestRateModel_, initialExchangeRateMantissa_,
