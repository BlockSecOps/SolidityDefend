        ...
        if let Some((_, _)) = results.first() {
            ...
            Ok(ComparisonResult {
                ...
                min_metrics: PerformanceMetrics {
                    tool_name: "min".to_string(),
                    analysis_time: Duration::from_secs(4),
                    memory_usage: 45 * 1024 * 1024,
                    findings_count: 8,
                    success_rate: 1.0,
                },
                max_metrics: PerformanceMetrics {
                    tool_name: "max".to_string(),
                    analysis_time: Duration::from_secs(6),
                    memory_usage: 55 * 1024 * 1024,
                    findings_count: 12,
                    success_rate: 1.0,
                },
                runs: vec![],
